 ...
 ******************************************************************************/
void CMU_FlashWaitStateMax(void)
{
	uint32_t cfg;
 ...
 ******************************************************************************/
void CMU_FlashWaitStateControl(uint32_t hfcoreclk)
{
	uint32_t cfg;
 ...
 *   returned.
 ******************************************************************************/
uint32_t CMU_LFClkGet(unsigned int lfClkBranch)
{
	uint32_t ret;
...
CMU_ClkDiv_TypeDef CMU_ClockDivGet(CMU_Clock_TypeDef clock)
{
	...
	case CMU_HFCLKDIV_REG:
		ret = 1 + ((CMU->CTRL & _CMU_CTRL_HFCLKDIV_MASK) >> _CMU_CTRL_HFCLKDIV_SHIFT);
		break;
#endif

	case CMU_HFPERCLKDIV_REG:
		ret = (CMU_ClkDiv_TypeDef)((CMU->HFPERCLKDIV & _CMU_HFPERCLKDIV_HFPERCLKDIV_MASK) >> _CMU_HFPERCLKDIV_HFPERCLKDIV_SHIFT);
		ret = CMU_Log2ToDiv(ret);
		break;

	case CMU_HFCORECLKDIV_REG:
		ret = (CMU_ClkDiv_TypeDef)((CMU->HFCORECLKDIV & _CMU_HFCORECLKDIV_HFCORECLKDIV_MASK) >> _CMU_HFCORECLKDIV_HFCORECLKDIV_SHIFT);
		ret = CMU_Log2ToDiv(ret);
		break;
	...
	case CMU_LFAPRESC0_REG:
		...
		{
		case cmuClock_RTC:
			ret = (CMU_ClkDiv_TypeDef)(((CMU->LFAPRESC0 & _CMU_LFAPRESC0_RTC_MASK) >> _CMU_LFAPRESC0_RTC_SHIFT));
			ret = CMU_Log2ToDiv(ret);
			break;

#if defined(_CMU_LFAPRESC0_LETIMER0_MASK)
		case cmuClock_LETIMER0:
			ret = (CMU_ClkDiv_TypeDef)(((CMU->LFAPRESC0 & _CMU_LFAPRESC0_LETIMER0_MASK) >> _CMU_LFAPRESC0_LETIMER0_SHIFT));
			ret = CMU_Log2ToDiv(ret);
			break;
#endif
		...
		case cmuClock_LCDpre:
			ret = (CMU_ClkDiv_TypeDef)(((CMU->LFAPRESC0 & _CMU_LFAPRESC0_LCD_MASK) >> _CMU_LFAPRESC0_LCD_SHIFT) + CMU_DivToLog2(cmuClkDiv_16));
			ret = CMU_Log2ToDiv(ret);
			break;
#endif
		...
		case cmuClock_LESENSE:
			ret = (CMU_ClkDiv_TypeDef)(((CMU->LFAPRESC0 & _CMU_LFAPRESC0_LESENSE_MASK) >> _CMU_LFAPRESC0_LESENSE_SHIFT));
			ret = CMU_Log2ToDiv(ret);
			break;
#endif
	...
	case CMU_LFBPRESC0_REG:
		...
		case cmuClock_LEUART0:
			ret = (CMU_ClkDiv_TypeDef)(((CMU->LFBPRESC0 & _CMU_LFBPRESC0_LEUART0_MASK) >> _CMU_LFBPRESC0_LEUART0_SHIFT));
			ret = CMU_Log2ToDiv(ret);
			break;
#endif
		...
		case cmuClock_LEUART1:
			ret = (CMU_ClkDiv_TypeDef)(((CMU->LFBPRESC0 & _CMU_LFBPRESC0_LEUART1_MASK) >> _CMU_LFBPRESC0_LEUART1_SHIFT));
			ret = CMU_Log2ToDiv(ret);
			break;
#endif
 ...
 *	 returning.
 ******************************************************************************/
void CMU_OscillatorEnable_HFRCO(bool enable, bool wait)
{
	if (enable)
	{
